...
const NAMES_FIRST = [
  "Айра", "Борун", "Селена", "Дорн", "Эйва", "Феникс", "Грант", "Хелена", "Ивар", "Кира", "Лиам", "Мира", "Найра", "Орик", "Пайк", "Ривен", "Сорель", "Талия", "Ульф", "Вейс",
  "Арден", "Бруна", "Виктор", "Грета", "Дейн", "Эллис", "Жан", "Зара", "Кассия", "Лорен", "Маркус", "Нико", "Ольга", "Петра", "Руфус", "Саймон", "Торин", "Урса", "Фара", "Хьюго",
];
const NAMES_LAST = [
  "Блэквуд", "Камнерез", "Серебродол", "Пепельный", "Ветрозвук", "НочнойСтранник", "Камнетёс", "Бурелом", "Солнцевск", "МорскаяСоль",
  "Железнорук", "ТуманныйБерег", "КровавыйКлюч", "СеверныйВетер", "ЛуннаяТропа", "КаменныйМост", "ПепельнаяДолина", "СтарыйПричал",
];
const EPITHETS = [
  "Тихая сталь", "Пепельный смех", "Двугранник", "Сонный кот", "Красное перо", "Безымянная печать", "Третий палец",
  "Серый шпион", "Последний свидетель", "Холодный расчёт", "Золотая ложь", "Пепел на губах",
];
...
const ROLES = [
  ...
  "следопыт-контрабандист",
  "колдунья-целительница",
  "наёмник без прошлого",
  "писарь-шпион",
  "кузнец-алхимик",
  "капитан речной баржи",
  "жрец изгнанник",
];
